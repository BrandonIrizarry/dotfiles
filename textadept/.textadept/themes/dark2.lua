...
property['color.cyan'] = 0xffff00
property['color.white'] = 0xffffff
...
property['style.comment'] = 'fore:$(color.white)'
property['style.constant'] = 'fore:$(color.green),bold'
property['style.embedded'] = '$(style.keyword),back:$(color.black)'
property['style.error'] = 'fore:$(color.red),bold'
property['style.function'] = 'fore:$(color.blue),bold'
property['style.keyword'] = 'fore:$(color.yellow)'
property['style.identifier'] = 'fore:$(color.white)'
property['style.label'] = 'fore:$(color.cyan),bold'
property['style.number'] = 'fore:$(color.cyan)'
property['style.operator'] = 'fore:$(color.white),bold'
