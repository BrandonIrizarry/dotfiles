...
--[[
	BCI: We took out the deprecated stylings for now. For both functions and 
libraries, we separated the long-string list of deprecated items into a separate 
local variable, and then replaced the input to 'word_match' with the empty string.
]]
